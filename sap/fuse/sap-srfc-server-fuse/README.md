...
* In the JBoss Fuse console, run `install -s mvn:org.jboss.quickstarts.fuse/sap-srfc-server-fuse` to install the quick start. Note the bundle number for the quick start returned by this command.  
