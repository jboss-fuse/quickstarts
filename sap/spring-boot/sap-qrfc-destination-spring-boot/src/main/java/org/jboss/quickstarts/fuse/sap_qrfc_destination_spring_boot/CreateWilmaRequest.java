 ...
 * 
 */
package org.jboss.quickstarts.fuse.sap_qrfc_destination_spring_boot;
 ...
 *
 */
public class CreateWilmaRequest {
	...
	public void createRequest(Exchange exchange) throws Exception {
		...
		SapQueuedRfcDestinationEndpoint endpoint = exchange.getContext().getEndpoint("sap-qrfc-destination:quickstartDest:QUICKSTARTQUEUE:BAPI_FLCUST_CREATEFROMDATA", SapQueuedRfcDestinationEndpoint.class);
		...
		customerData.put("CUSTNAME", "Wilma Flintstone");
		customerData.put("FORM", "Mrs.");
		...
		customerData.put("EMAIL", "wilma@bedrock.com");
