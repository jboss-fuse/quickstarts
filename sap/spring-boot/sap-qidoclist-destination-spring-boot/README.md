Spring Boot SAP Queued IDoc List Destination Endpoint Quick Start
================================================================
**Demonstrates the sap-qidoclist-destination component running in a spring boot camel runtime.**  
...
Summary: This quickstart demonstrates how to configure and use the sap-qidoclist-destination component in a Spring Boot Camel environment to send Intermediate Document (IDoc) lists to SAP. This component sends document lists to SAP using the *Queued RFC* (tRFC) protocol.  
Target Product: Fuse  
...
1. Change your working directory to the `sap-qidoclist-destination-spring-boot` directory.
