...
Target Product: Fuse  
Source: <http://github.com/punkhorn/sap-quickstarts/sap-idoc-destination-standalone>  

What is it?  
-----------  

This quick start shows how to integrate Apache Camel with SAP using the JBoss Fuse SAP IDoc Camel component.   
