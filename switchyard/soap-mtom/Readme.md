...
2. Install the feature for the soap-mtom quickstart :

JBossFuse:karaf@root> features:install switchyard-quickstart-soap-mtom
...
JBossFuse:karaf@root> features:uninstall switchyard-quickstart-soap-mtom
