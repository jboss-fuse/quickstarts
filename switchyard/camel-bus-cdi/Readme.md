...
2. Install the feature for the camel-bus-cdi quickstart :

JBossFuse:karaf@root> features:install switchyard-quickstart-camel-bus-cdi
...
JBossFuse:karaf@root> features:uninstall switchyard-quickstart-camel-bus-cdi
