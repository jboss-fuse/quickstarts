...
2. Install the feature for the transform-smooks quickstart :

JBossFuse:karaf@root> features:install switchyard-quickstart-transform-smooks
...
JBossFuse:karaf@root> features:uninstall switchyard-quickstart-transform-smooks
